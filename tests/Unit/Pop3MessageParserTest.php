...
class Pop3MessageParserTest extends TestCase{
    ...
    public function comment_parser_returns_null_user_if_is_the_requester() {
        ...
        $parser1 = new Pop3MessageCommentParser(new FakePop3Message(["name" => "Bruce Wayne", "email" => "james@bond.com"], "I'm batman", "##- Please type your reply above this line -## ticket-id:1."));
    ...
    public function comment_parser_returns_the_user_if_it_is_not_the_requester() {
        ...
        $requester = factory(Requester::class)->create(["email" => "james@bond.com"]);
        $ticket = factory(Ticket::class)->create(["requester_id" => $requester->id]);
        $parser1 = new Pop3MessageCommentParser(new FakePop3Message(["name" => "Bruce Wayne", "email" => "bruce@wayne.com"], "I'm batman", "##- Please type your reply above this line -## ticket-id:1."));
    ...
    public function comment_parser_returns_null_if_it_is_an_unknown_email() {
        $requester = factory(Requester::class)->create(["email" => "james@bond.com"]);
        $ticket = factory(Ticket::class)->create(["requester_id" => $requester->id]);
        $parser1 = new Pop3MessageCommentParser(new FakePop3Message(["name" => "Bruce Wayne", "email" => "unkown@bond.com"], "I'm batman", "##- Please type your reply above this line -## ticket-id:1."));
